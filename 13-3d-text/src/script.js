...
fontsLoader.load("/fonts/helvetiker_regular.typeface.json", (font) => {
    const textGeometry = new TextGeometry("3JS Text Practice", {
        font,
        size: 0.5,
        height: 0.2,
        curveSegments: 6,
    ...
    //     //Substract bevel size at X & Y axes and bevel Thickness at Z axes
